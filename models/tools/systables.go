...
func (e *SysTables) GetPage(pageSize, pageIndex int) ([]SysTables, int, error)  {
	var doc []SysTables
...
func (e *SysTables) Delete() (success bool, err error) {
	if err = orm.Eloquent.Table("sys_tables").Delete(SysTables{}, "tsble_id=?",e.TableId).Error;err!=nil{
		success = false
		return
	}
